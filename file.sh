...
echo -e "\e[1;34m [+] finding robots.txt file from subdomian \e[0m"
...
ffuf -w validsubdomain-iagcargo.com.txt:URL -w robot-words.txt:DIR -u URL/DIR -mc 200,403 -t 350 -of html -o result.html
